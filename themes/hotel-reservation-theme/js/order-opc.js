...
$(document).ready(function()
{
	...
	$(document).on('click', '#rooms_extra_services .qty_up', function(e) {
		...
		roomServiceProductValue = $('.room-service-product-value');
		...
		if (qtyfield.data('max_quantity') && qtyfield.data('max_quantity') < newQuantity) {
			...
			roomServiceProductValue.text(roomServiceProductCurrencySign + roomServiceProductTotalPriceQtyUp.toFixed(2))
    ...
    $(document).on('click', '#rooms_extra_services .qty_down', function(e) {
        ...
        if (!isNaN(currentVal) && currentVal > 1) {
			...
			roomServiceProductValue.text(roomServiceProductCurrencySign + roomServiceProductTotalPriceQtyDown.toFixed(2))
    ...
    $(document).on('focusout', '#rooms_extra_services .qty', function(e) {
		...
		roomServiceProductValue.text(roomServiceProductCurrencySign + roomServiceProductTotalPriceQty.toFixed(2))
