    ...
    public function getModuleSql()
    {
        return array(
            ...
            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."htl_branch_info` (
                ...
                `fixed_tax_value` decimal(20,6) NOT NULL DEFAULT '0.000000',
                `fixed_tax_calc_method` tinyint(1) unsigned NOT NULL DEFAULT '1',
                `fixed_tax_occupancy_based` tinyint(1) unsigned NOT NULL DEFAULT '0',
                `fixed_tax_apply_on_child` tinyint(1) unsigned NOT NULL DEFAULT '1',
                `fixed_tax_apply_on_infant` tinyint(1) unsigned NOT NULL DEFAULT '0',
                `fixed_tax_enabled` tinyint(1) unsigned NOT NULL DEFAULT '0',
            ...
            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."htl_branch_info_lang` (
                ...
                `fixed_tax_name` varchar(255) DEFAULT NULL,
